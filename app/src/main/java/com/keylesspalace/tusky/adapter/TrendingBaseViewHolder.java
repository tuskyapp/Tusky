...
public abstract class TrendingBaseViewHolder extends RecyclerView.ViewHolder {
    ...
    protected TrendingBaseViewHolder(View itemView) {
        super(itemView);
    ...
    public void setupWithTrending(TrendingViewData.Tag tag, final StatusActionListener listener,
                                  StatusDisplayOptions statusDisplayOptions) {
        this.setupWithTrending(tag, listener, statusDisplayOptions, null);
    }

    public void setupWithTrending(@NonNull TrendingViewData.Tag tag,
                                  @NonNull final StatusActionListener listener,
                                  @NonNull StatusDisplayOptions statusDisplayOptions,
                                  @Nullable Object payloads) {
        if (payloads == null) {
            setUsername(tag.getTag().getName());
        }
//            Status actionable = tag.getActionable();
...
//            setMetaData(tag, statusDisplayOptions, listener);
//            setIsReply(actionable.getInReplyToId() != null);
//            setReplyCount(actionable.getRepliesCount());
//            setAvatar(actionable.getAccount().getAvatar(), tag.getRebloggedAvatar(),
...
//                setMediaPreviews(attachments, sensitive, listener, tag.isShowingContent(), statusDisplayOptions.useBlurhash());
//
...
//                }
//            } else {
//                setMediaLabel(attachments, sensitive, listener, tag.isShowingContent());
...
//
//            if (cardView != null) {
//                setupCard(tag, statusDisplayOptions.cardViewMode(), statusDisplayOptions, listener);
//            }
//
//            setupButtons(listener, actionable.getAccount().getId(), tag.getContent().toString(),
//                    statusDisplayOptions);
//            setRebloggingEnabled(actionable.rebloggingAllowed(), actionable.getVisibility());
//
//            setSpoilerAndContent(tag.isExpanded(), tag.getContent(), tag.getSpoilerText(),
...
//                    listener);
//
//            setDescriptionForStatus(tag, statusDisplayOptions);
//
