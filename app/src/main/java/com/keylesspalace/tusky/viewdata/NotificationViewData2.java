...
public abstract class NotificationViewData2 {
    private NotificationViewData2() {
    }

    public abstract long getViewDataId();

    public abstract boolean deepEquals(NotificationViewData2 other);

    public static final class Concrete extends NotificationViewData2 {
        ...
        @Override
        public boolean deepEquals(NotificationViewData2 o) {
    ...
    public static final class Placeholder extends NotificationViewData2 {
        ...
        @Override
        public boolean deepEquals(NotificationViewData2 other) {
