...
import tech.bigfig.roma.db.InstanceEntity;
...
import static tech.bigfig.roma.util.MediaUtilsKt.MEDIA_SIZE_UNKNOWN;
...
public final class ComposeActivity
    ...
    private void showContentWarning(boolean show) {
        ...
        if (show) {
            ...
            contentWarningButton.setTextColor(ContextCompat.getColor(this, R.color.roma_blue));
